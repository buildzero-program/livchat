...
export function AuthModal({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md p-0 gap-0 overflow-hidden border-border/50 shadow-2xl">
        {/* Accessible title and description - visually hidden */}
        <DialogTitle className="sr-only">Login</DialogTitle>
        <DialogDescription className="sr-only">
          Entre na sua conta usando Google ou GitHub
        </DialogDescription>

        {/* Header with gradient background */}
        <div className="flex flex-col items-center gap-2 bg-gradient-to-b from-muted/50 to-background px-6 pt-8 pb-6">
          {/* Logo */}
          ...
          <h1 className="text-xl font-semibold tracking-tight" aria-hidden="true">LivChat</h1>
